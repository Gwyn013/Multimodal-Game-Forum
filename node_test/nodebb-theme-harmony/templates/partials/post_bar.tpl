<div class="{{{ if config.theme.stickyToolbar }}}sticky-tools{{{ end }}}">
	<nav class="d-flex flex-nowrap my-2 p-0 border-0 rounded topic-main-buttons">
		<div class="d-flex flex-row p-2 postBar-bg-light border rounded w-100 align-items-center">
			<div class="d-flex me-auto mb-0 gap-2 align-items-center flex-wrap">
				<!--{{{ if loggedIn }}}
				<button component="topic/mark-unread" class="btn btn-ghost postBar-btn btn-sm ff-secondary d-flex gap-2 align-items-center">
					<i class="fa fa-fw fa-inbox text-primary"></i>
					<span class="d-none d-md-inline postBar-btn-text">[[topic:mark-unread]]</span>
				</button>
				{{{ end }}}-->
