...
<div class="btn-group bottom-sheet" component="topic/watch">
	<button class="btn btn-ghost postBar-btn btn-sm ff-secondary d-flex gap-2 dropdown-toggle" data-bs-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
		<span component="topic/following/menu" class="d-flex gap-2 align-items-center{{{ if !isFollowing }}} hidden{{{ end }}}">
			...
			<span class="d-none d-md-inline postBar-btn-text">[[topic:watching]]</span>
		</span>
		...
		<span component="topic/not-following/menu" class="d-flex gap-2 align-items-center{{{ if !isNotFollowing}}} hidden{{{ end }}}">
			...
			<span class="d-none d-md-inline postBar-btn-text">[[topic:not-watching]]</span>
		</span>
		...
		<span component="topic/ignoring/menu" class="d-flex gap-2 align-items-center{{{ if !isIgnoring }}} hidden{{{ end }}}">
			...
			<span class="d-none d-md-inline postBar-btn-text">[[topic:ignoring]]</span>
		</span>
	</button>
